...
namespace MyCloudProject
{
    class Program
    {
        ...
        /// </summary>
        private static string projectName = "ML 21/22-28";
        //Test Project : Improve Unit Test(Temporal Memory)
        ...
        static async Task Main(string[] args)
        {
            ...
            Experiment experiment = new Experiment(cfgSec, storageProvider, logger/* put some additional config here */, null);
